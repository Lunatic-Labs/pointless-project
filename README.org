...
#+begin_src bash
  #!/bin/bash
  cd ..
  touch ./integrated-tests/<name-of-test>_output_$current_datetime.txt
  ...
  # delete output.txt (rm ./integrated-tests/<name-of-test>_output_$current_datetime.txt) and any edits to csv (sed -i '$d' ./includes/contact-data.csv)
#+end_src
