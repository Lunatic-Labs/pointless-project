...
Encrypt:
    - [X] Boring as all could be.
    - [X] Change "words" to "phrase"
    - [X] Add a "What is the decrypted password" to the end

Based:
    - [X] It is based.

Maze rematch:
    - [X] NEEDS to say console.
